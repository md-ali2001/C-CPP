...
class Abdullah: public human  // abdullah is derived from human in public mode
{
    ...
    Abdullah ()                    // default constructor
    {
        cnic="000";
        course="default";
        human();        // calling parent class default constructor to initialize inherited attributes
        
    }
    
   Abdullah(string cnic,string course,char gender,int age,string  pass):human( gender,age,pass)  // first of all write all the parameters inside child class bracket with datatype , then in parent class bracket, write inherited attributes without datatype and with same name in child class
   {
       this->cnic=cnic;
       this->course=course;
...
//   h4.showdata();
   ...
   Abdullah a2("432","programming",'M',19,"123");
   a2.showdata();
